...
+
** link:https://docs.couchbase.com/userprofile-couchbase-mobile/standalone/userprofile/android/userprofile_basic.html[Fundamentals] of using Couchbase Lite 2.0 as a standalone database
...
./sync_gateway /path/to/UserProfileDemo/modules/userprofile/examples/src/sync-gateway-config-userprofile-walrus.json
----
+
...
[source,bash]
----
~/couchbase-sync-gateway/bin | => ./sync_gateway ~/projects/android/UserProfileDemo/modules/userprofile/examples/src/sync-gateway-config-userprofile-walrus.json 
