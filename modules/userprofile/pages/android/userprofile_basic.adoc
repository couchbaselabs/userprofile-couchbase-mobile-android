...
:imagesdir: ../../assets/images/android
...
== Prerequisites
This tutorial assumes familiarity with building Android apps using link:https://www.java.com[Java].

* link:https://developer.android.com/studio[Android Studio 2.3.3 or above]
...
image::user_profile.gif[200,400]
...
```
<1> Special link:https://docs.couchbase.com/couchbase-lite/2.0/java.html#blobs[`Blob`] data type that is associated with the profile image.  

=== UserProfile 

For the purpose of this tutorial the _"user"_ `Document` is first stored witin an `Object` of type `Map<String, Object>`.
